...
import GridSanad from "./GridSanad";
import { connect } from "react-redux";
import GenModal from "../../modal";
import { passIdsActions } from "../../../store/ducks/passIds.duck";

const PopupCurdSanad = (props) => {

    const { title, columns, urls, refreshCopySanad, refreshHandler, form, searchForm, key, initFormValues, backButton, moreColumn,listSrlState } = props
    ...
    // console.log("PopupCurdSanad", props.listSrlState);
    ...
    const CntrlCountList = () => {
        ...
        b.UAUSER_SRL = listSrlState.UAUSER_SRL;
        b.VOU = listSrlState.VOU;
        b.GADURA_SRL = listSrlState.GADURA_SRL;
        b.GASYST_SRL = listSrlState.GASYST_SRL;
        ...
        baseService.post("/Sanad/Delete_daftardari", b).then(({ data }) => {
            ...
            console.log(error)
            dispatch(snackbarActions.error("خطا در ثبت سند دفترداری."))
    ...
    useEffect(() => {
        ...
        // console.log("PopupCurdSanad useEffect", listSrlState);
        let b = {};
        b.VOU =listSrlState.VOU;
        b.GADURA_SRL = listSrlState.GADURA_SRL;
        b.GASYST_SRL = listSrlState.GASYST_SRL;
    ...
    const editHandler = (item) => {
        debugger;
        // console.log("editHandlersanad", item)
        setEditMode(true);
    ...
    return (
        <>
            ...
            {/* {console.log("props.StatusOaplist", props.StatusOaplist,props.datacntrlsanad,props.VouDocument)} */}
            {/* {console.log("hasdatasanad_sanad", props.hasDataSanad)} */}
            ...
            <Portlet>
                    ...
                    toolbar={
                        (
                            <PortletHeaderToolbar>
                                { props.hasData === true && props.hasDataSanad === true && props.StatusOaplist === 0  ? //st===0
                                    <Button
                                ...
                                {props.datacntrlsanad === true && props.StatusOaplist === 2 && props.VouDocument !== null /*&& listSrlState.VOU !== null*/ ?
                ...
                <PortletBody>
                    ...
                    <GridSanad
                        listSrlState={listSrlState}
                        GetId={urls.GetId}
                        CheckdRow={urls.CheckdRow}
                        filter={filter}
                        url={urls.readUrl}
                        Value={urls.Value}
...
export default connect(mapStateToProps)(PopupCurdSanad);