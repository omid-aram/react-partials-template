...
import GridSanadPricingOpn from "./GridSanadPricingOpn";
import { connect } from "react-redux";
import { passIdsActions } from "../../../store/ducks/passIds.duck";


const PopupCurdSanadPricingOpn = (props) => {
    ...
    const CntrlCountList = () => {
        // debugger;
        let b = {};
        b.SRL = props.PricingListOpn.SRL;
        b.UAUSER_SRL = props.PricingListOpn.UAUSER_SRL;
        b.VOU = props.PricingListOpn.VOU;
        b.GADURA_SRL = props.PricingListOpn.GADURA_SRL;
        b.GASYST_SRL = props.PricingListOpn.GASYST_SRL;
                    ...
                    toolbar={
                        (
                            <PortletHeaderToolbar>
                                ...
                                { props.StatusOaplist === 2 && props.VouDocument !== null ?
...
export default connect(mapStateToProps)(PopupCurdSanadPricingOpn);