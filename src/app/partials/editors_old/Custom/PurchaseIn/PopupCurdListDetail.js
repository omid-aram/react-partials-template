...
import GridListDetail from "./GridListDetail";


const PopupCurdListDetail = (props) => {
    ...
    const deleteHandler = (item) => {
        console.log("deleteHandleritem",item.SRL);
    ...
    if (urls.deleteUrl) {
        finalColumns.push({
            ...
            template: (item) => (
                <>
                    {console.log("itemdeleteSRL", item.ST + "itemdeleteTEMP " + item.TEMPDOC_NO)}
                    {item.ST === 0 && item.TEMPDOC_NO === null ?
...
export default PopupCurdListDetail;