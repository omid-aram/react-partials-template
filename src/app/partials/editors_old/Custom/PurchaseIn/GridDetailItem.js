...
function GridDetailItem(props) {
    ...
    }, [page, rowsPerPage, filter, orderby, orderDir, offlineData, forceUpdate, localFilter,props.reload])
...
export default connect(mapStateToProps)(GridDetailItem);
