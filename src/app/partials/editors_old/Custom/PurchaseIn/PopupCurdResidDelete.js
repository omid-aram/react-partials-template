...
import GridResidDelete from "./GridResidDelete";


const PopupCurdResidDelete = (props) => {
    ...
    if (urls.deleteUrl) {
        finalColumns.push({
            ...
            template: (item) => (
                <>
                    {props.Status === 0 && props.TempdocNO === null ?
            ...
            <Portlet>
                ...
                <PortletBody>
                    ...
                    <GridResidDelete
                        GetId={urls.GetId}
                        filter={filter}
                        // showResid = {props.showResid}
                        selectedRow = {props.selectedRow}
                        LISTSRL={props.LIST_SRL}
                        url={urls.readUrl}
...
export default PopupCurdResidDelete;