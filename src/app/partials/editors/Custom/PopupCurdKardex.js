...
const PopupCurdKardex = (props) => {

    const user = useSelector(x => x.auth);
    const flag = useSelector(x => x.passIds.InputModalFlag);
    ...
    const searchHandler = (data) => {
       console.log("searchHandler" , data)
        ...
        //     dvfgxc: 545,
        //   });
         data.MALI_CODE = data.MALI_CODE === undefined || data.MALI_CODE === "" ? null : data.MALI_CODE;
         data.PO_NO = data.PO_NO === undefined || data.PO_NO === "" ? null :  data.PO_NO;
...
export default PopupCurdKardex;