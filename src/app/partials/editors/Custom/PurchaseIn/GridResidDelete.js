...
function GridResidDelete(props) {
    const {
        columns, //required
    ...
    }, [page, rowsPerPage, filter, orderby, orderDir, offlineData, forceUpdate, localFilter,props.LISTSRL , props.reload])
    ...
    //     baseService.post("/VwOapGrnSnap/DeleteOapgrh", sendData).then(({ data }) => {
...
const mapStateToProps = state => {
    ...
    return {
        ...
        reload : state.loader.isShowing
    };
};
export default connect(mapStateToProps)(GridResidDelete);
