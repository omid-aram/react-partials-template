...
import { Admin, User } from "../Partials/_Person"
...
const Person = (props) => {
    ...
    return (
        <>
            {role ===  Enums.RoleAccess.Admin && Enums.ApplicationId === app ? <Admin companyId={companyId} /> : role === Enums.RoleAccess.User && Enums.ApplicationId === app ? <User companyId={companyId} /> : null}
        </>
    )
}
