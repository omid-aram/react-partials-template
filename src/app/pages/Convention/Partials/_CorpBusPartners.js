...
export function Admin(props) {
    ...
    return (<>
        ...
        <CompanyPopupCrud
            ...
            columns={columns}
            title="مدیریت شرکا تجاری"
            urls={{
                readUrl: "/CompanyDetail/Show_BusPartner",
                createUrl: "/CompanyDetail/Create_BusPartner",
                deleteUrl: "/CompanyDetail/Delete_BusPartner",
                editUrl: "/CompanyDetail/Update_BusPartner"
            }}
            form={form}
        />
...
export function User(props) {
    ...
    return (<>
        <PopupCurd
            ...
            urls={{
                GetId: companyId,
                readUrl: "/CompanyDetail/Show_BusPartner_ToUser",
                createUrl: "/CompanyDetail/Create_BusPartner",
                deleteUrl: "/CompanyDetail/Delete_BusPartner",
                editUrl: "/CompanyDetail/Update_BusPartner"
            }}
