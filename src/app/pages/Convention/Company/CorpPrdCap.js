...
import { Admin, User } from "../Partials/_CorpPrdCap"
import Enums from '../Partials/Enums';
import { connect } from "react-redux";


const CorpPrdCap = (props) => {
    ...
    return (
        <>
            {role === Enums.RoleAccess.Admin && Enums.ApplicationId === app ? <Admin companyLocalFilter={companyLocalFilter} forceGridUpdate={forceGridUpdate} /> : Enums.RoleAccess.User && Enums.ApplicationId=== app ? <User companyId={companyId} /> : null}
        </>
    )
}
...
export default connect(mapStateToProps)(CorpPrdCap);